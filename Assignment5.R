...
# Zweiseitiger t-test: Signifikanzlevel α = 0.05; Konfidenzlevel = 1-α;Angenommener Mittelwert μ = 17
...
# Zweiseitiger t-test: Signifikanzlevel α = 0.01; Konfidenzlevel = 1-α;Angenommener Mittelwert μ = 17
t.test(bd$Blutdruck, alternative = "two.sided", mu = 17, conf.level = 0.99)
...
# Einseitiger t-test: Signifikanzlevel α = 0.05; Konfidenzlevel = 1-α;Angenommener Mittelwert μ = 17
# H0: Der mittlere Blutdruck weicht nach der Gabe des Medikaments nicht kleiner als 17.
# H1 : Der mittlere Blutdruck ist nach der Gabe des Medikaments kleiner als 17
...
# Einseitiger t-test: Signifikanzlevel α = 0.05; Konfidenzlevel = 1-α;Angenommener Mittelwert μ = 17
# H0: Der mittlere Blutdruck ist nach der Gabe des Medikaments größer als in der Kontrollgruppe.
# H1 : Der mittlere Blutdruck ist nach der Gabe des Medikaments größer als in der Kontrollgruppe.
...
#data:  A and B
#t = -0.96989, df = 163.62, p-value = 0.3335
